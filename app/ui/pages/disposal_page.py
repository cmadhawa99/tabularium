...
class DisposalPage(QWidget):
    ...
    def setup_ui(self):
        ...
        # -------------------------------------------------------------------------------------
        search_frame = QFrame()
        search_frame.setStyleSheet("background-color: #27293d; border-radius: 10px; padding: 20px;")
        search_layout = QHBoxLayout(search_frame)

        self.inp_search = QLineEdit()
        self.inp_search.setPlaceholderText("Enter RR Number to Manage (e.g., RR-2024-001)...")
        self.inp_search.setHeight(40) if hasattr(self.inp_search, 'setHeight') else self.inp_search.setFixedHeight(40)
        ...
        btn_search.setStyleSheet("background-color: #3498db; color: white; padding: 10px;")
        ...
        # Scheduled Removal
        # -------------------------------------------------------------------------------------
        self.grp_schedule = QGroupBox("Schedule Removal")
        ...
        btn_update_schedule.setStyleSheet("background-color: #e14eca; color: white;")
        btn_update_schedule.clicked.connect(self.update_schedule)

        sch_layout.addWidget(QLabel("To Be Removed Date:"))
        ...
        # Perma Removal
        # -------------------------------------------------------------------------------------
        self.grp_remove =QGroupBox("Permanent Removal")
        ...
        lbl_warning.setStyleSheet("color: #ff7675; font-style: italic;")
        ...
        self.btn_remove.setStyleSheet("background-color: #e74c3c; color: white; font-weight: bold;")
